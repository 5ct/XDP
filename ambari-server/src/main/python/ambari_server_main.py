...
def server_process_main(options, scmStatus=None):
  ...
  if options.skip_database_check:
    ...
    print "xdp Server is starting with the database consistency check skipped. Do not make any changes to your cluster " \
    ...
    print "xdp database consistency check started..."
