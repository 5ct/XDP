...
class BootstrapDefault(Bootstrap):
  ...
  def copyAmbariSudo(self):
    ...
    params = self.shared_state
    self.host_log.write("==========================\n")
    self.host_log.write("Copying xdp sudo script...")
  ...
  def copyNeededFiles(self):
    ...
    if (os.path.exists(fileToCopy)):
      ...
      self.host_log.write("==========================\n")
      self.host_log.write("Changing permissions for xdp.repo...")
      ...
      self.host_log.write("xdp repo file not found: {0}".format(self.getRepoFile()))
      retcode = -1
      pass
